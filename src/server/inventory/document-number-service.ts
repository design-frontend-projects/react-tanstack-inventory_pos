...
const DEFAULT_PREFIX: Record<DocumentType, string> = {
  ...
  AR_RECEIPT: 'ARR',
  PAYMENT_RUN: 'PMR',
  CASH_TRANSACTION: 'CSH',
  FUNDS_TRANSFER: 'FTR',
  DEPRECIATION_RUN: 'DEP',
  FX_REVALUATION: 'FXR',
  TAX_RETURN: 'TAXR',
  OPENING_BALANCE: 'OB',
  ALLOCATION_RUN: 'ALC',
  ...
  HR_CANDIDATE: 'CND',
  HR_JOB_OFFER: 'OFR',
  HR_LEAVE_REQUEST: 'LVR',
  HR_OVERTIME_REQUEST: 'OTR',
  HR_TIMESHEET: 'TMS',
  HR_PAYROLL_RUN: 'PAYR',
  HR_LOAN: 'LOAN',
  HR_SALARY_ADVANCE: 'ADV',
  HR_PERFORMANCE_REVIEW: 'PRV',
  HR_TRAVEL_REQUEST: 'TRV',
  HR_EXPENSE_CLAIM: 'EXP',
}
