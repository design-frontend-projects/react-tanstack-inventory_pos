...
export const ROLE_DEFINITIONS = [
  ...
  },
  {
    ...
    name: 'HR Manager',
    description:
      'Manages the full HCM module: organization, employees, recruitment, time, leave, payroll, performance, and HR settings.',
    isSystem: true,
    rank: 64,
  },
  {
    ...
    name: 'HR Officer',
    description:
      'Day-to-day HR operations: employee records, organization, recruitment, attendance, and leave processing.',
    isSystem: true,
    rank: 54,
  },
  {
    ...
    description:
      'Runs and reviews payroll, loans, advances, and expense reimbursements; posts payroll to finance.',
    isSystem: true,
    rank: 55,
  },
] as const
...
export const PERMISSION_DEFINITIONS = [
  ...
  {
    code: 'inventory.count_view',
    name: 'View Stock Counts',
    moduleKey: 'inventory',
    actionKey: 'count_view',
    description: 'View stock count sessions and variance results.',
  },
  {
    code: 'inventory.count_manage',
    name: 'Manage Stock Counts',
    moduleKey: 'inventory',
    actionKey: 'count_manage',
    description: 'Create count sessions and record counted quantities.',
  },
  {
    code: 'inventory.count_approve',
    name: 'Approve Stock Counts',
    moduleKey: 'inventory',
    actionKey: 'count_approve',
    description: 'Approve variances and post the resulting stock adjustment.',
  },
  {
  ...
  {
    code: 'hr.analytics_view',
    name: 'View HR Analytics',
    moduleKey: 'hr',
    actionKey: 'analytics_view',
    description: 'View the HR overview dashboard and workforce analytics.',
  },
  {
    code: 'hr.org_view',
    ...
    actionKey: 'org_view',
    description:
      'View the organization structure: companies, branches, departments, positions, grades, and cost centers.',
  },
  {
    code: 'hr.org_manage',
    name: 'Manage Organization',
    moduleKey: 'hr',
    actionKey: 'org_manage',
    description:
      'Create and maintain the organization structure and reporting hierarchy.',
  },
  {
    code: 'hr.employee_view',
    name: 'View Employees',
    moduleKey: 'hr',
    actionKey: 'employee_view',
    description: 'View employee master data, profiles, contracts, and history.',
  },
  {
    code: 'hr.employee_manage',
    name: 'Manage Employees',
    moduleKey: 'hr',
    actionKey: 'employee_manage',
    description:
      'Create and update employees, contracts, documents, and employment records.',
  },
  {
    code: 'hr.recruitment_view',
    name: 'View Recruitment',
    moduleKey: 'hr',
    actionKey: 'recruitment_view',
    description: 'View job openings, candidates, interviews, and offers.',
  },
  {
    code: 'hr.recruitment_manage',
    name: 'Manage Recruitment',
    moduleKey: 'hr',
    actionKey: 'recruitment_manage',
    description:
      'Manage the applicant tracking pipeline: openings, candidates, interviews, and offers.',
  },
  {
    code: 'hr.attendance_view',
    name: 'View Attendance',
    moduleKey: 'hr',
    actionKey: 'attendance_view',
    description: 'View attendance logs, daily attendance, and timesheets.',
  },
  {
    code: 'hr.attendance_manage',
    name: 'Manage Attendance',
    moduleKey: 'hr',
    actionKey: 'attendance_manage',
    description:
      'Manage shifts, attendance corrections, timesheets, and overtime.',
  },
  {
    code: 'hr.leave_view',
    name: 'View Leave',
    moduleKey: 'hr',
    actionKey: 'leave_view',
    description: 'View leave types, balances, and requests.',
  },
  {
    code: 'hr.leave_request',
    name: 'Request Leave',
    moduleKey: 'hr',
  ...
  {
    code: 'hr.leave_approve',
    name: 'Approve Leave',
    moduleKey: 'hr',
    actionKey: 'leave_approve',
    description: 'Approve or reject leave requests for the team.',
  },
  {
    code: 'hr.payroll_view',
    name: 'View Payroll',
    moduleKey: 'hr',
    actionKey: 'payroll_view',
    description: 'View payroll periods, runs, and payslips.',
  },
  {
    code: 'hr.payroll_run',
    name: 'Run Payroll',
    moduleKey: 'hr',
    actionKey: 'payroll_run',
    description: 'Create and calculate payroll runs.',
  },
  {
    code: 'hr.payroll_post',
    name: 'Post Payroll',
    moduleKey: 'hr',
    actionKey: 'payroll_post',
    description: 'Approve and post payroll runs to finance and payment.',
  },
  {
    code: 'hr.loan_manage',
    name: 'Manage Loans & Advances',
    moduleKey: 'hr',
    actionKey: 'loan_manage',
    description: 'Manage employee loans, installments, and salary advances.',
  },
  {
    code: 'hr.performance_view',
    name: 'View Performance',
    moduleKey: 'hr',
    actionKey: 'performance_view',
    description: 'View goals, KPIs, and performance reviews.',
  },
  {
    code: 'hr.performance_manage',
    name: 'Manage Performance',
    moduleKey: 'hr',
    actionKey: 'performance_manage',
    description: 'Manage goals, KPIs, review cycles, and scores.',
  },
  {
    code: 'hr.training_manage',
    name: 'Manage Training',
    moduleKey: 'hr',
    actionKey: 'training_manage',
    description: 'Manage training courses, sessions, records, and certificates.',
  },
  {
    code: 'hr.expense_view',
    name: 'View Travel & Expense',
    moduleKey: 'hr',
    actionKey: 'expense_view',
    description: 'View travel requests and expense claims.',
  },
  {
    code: 'hr.expense_manage',
    name: 'Manage Travel & Expense',
    moduleKey: 'hr',
    actionKey: 'expense_manage',
    description: 'Submit and process travel requests, expense claims, and reimbursements.',
  },
  {
    code: 'hr.expense_approve',
    name: 'Approve Travel & Expense',
    moduleKey: 'hr',
    actionKey: 'expense_approve',
    description: 'Approve travel requests and expense claims.',
  },
  {
    code: 'hr.settings_manage',
    name: 'Manage HR Settings',
    moduleKey: 'hr',
    actionKey: 'settings_manage',
    description:
      'Configure HR settings: salary components, leave policies, shift definitions, and templates.',
  },
] as const
