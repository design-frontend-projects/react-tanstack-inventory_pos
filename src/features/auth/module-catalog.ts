...
export const MODULE_DEFINITIONS: ReadonlyArray<ModuleDefinition> = [
  ...
  },
  {
    code: 'crm',
    name: 'CRM',
    description: 'Customer intelligence: profiles, loyalty, segments, and analytics.',
    icon: 'HeartHandshake',
    displayOrder: 4,
    titleKey: 'nav.crm',
...
export const PERMISSION_LINKS: Record<PermissionCode, PermissionLink> = {
  ...
  'product.view': { moduleCode: 'inventory', screenCode: 'inventory-catalog', actionCode: null, kind: 'screen' },
  'product.create': { moduleCode: 'inventory', screenCode: 'inventory-catalog', actionCode: null, kind: 'action' },
  'product.update': { moduleCode: 'inventory', screenCode: 'inventory-catalog', actionCode: null, kind: 'action' },
  'product.delete': { moduleCode: 'inventory', screenCode: 'inventory-catalog', actionCode: null, kind: 'action' },
  'product.manage_pricing': { moduleCode: 'inventory', screenCode: 'inventory-catalog', actionCode: null, kind: 'action' },
  'product.manage_categories': { moduleCode: 'inventory', screenCode: 'inventory-catalog', actionCode: null, kind: 'action' },
  'supplier.view': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'data' },
  'supplier.manage': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'customer.view': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'data' },
  'customer.manage': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'tax.manage': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'admin' },
  'warehouse.view': { moduleCode: 'inventory', screenCode: 'inventory-outlets', actionCode: null, kind: 'screen' },
  'warehouse.create': { moduleCode: 'inventory', screenCode: 'inventory-outlets', actionCode: null, kind: 'action' },
  'warehouse.update': { moduleCode: 'inventory', screenCode: 'inventory-outlets', actionCode: null, kind: 'action' },
  'warehouse.manage_locations': { moduleCode: 'inventory', screenCode: 'inventory-outlets', actionCode: null, kind: 'action' },
  'inventory.view_stock': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'screen' },
  'inventory.view_movements': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'data' },
  'inventory.reserve': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'action' },
  'inventory.manage_lots': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'action' },
  'inventory.manage_serials': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'action' },
  'inventory.manage_reorder': { moduleCode: 'inventory', screenCode: 'inventory-overview', actionCode: null, kind: 'action' },
  'inventory.view_valuation': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'data' },
  'adjustment.view': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'screen' },
  'adjustment.create': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'action' },
  'adjustment.post': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'action' },
  'transfer.view': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'screen' },
  'transfer.create': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'action' },
  'transfer.ship': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'action' },
  'transfer.receive': { moduleCode: 'inventory', screenCode: 'inventory-stock', actionCode: null, kind: 'action' },
  'purchase.requisition_view': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'screen' },
  'purchase.requisition_manage': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'purchase.po_view': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'screen' },
  'purchase.po_create': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'purchase.po_approve': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'purchase.po_receive': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'purchase.return_manage': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'sales.order_view': { moduleCode: 'pos', screenCode: 'pos-orders', actionCode: null, kind: 'screen' },
  'sales.order_create': { moduleCode: 'pos', screenCode: 'pos-orders', actionCode: null, kind: 'action' },
  'sales.order_confirm': { moduleCode: 'pos', screenCode: 'pos-orders', actionCode: null, kind: 'action' },
  'sales.order_fulfill': { moduleCode: 'pos', screenCode: 'pos-orders', actionCode: null, kind: 'action' },
  'sales.invoice_manage': { moduleCode: 'pos', screenCode: 'pos-orders', actionCode: null, kind: 'action' },
  'pos.access': { moduleCode: 'pos', screenCode: 'pos-checkout', actionCode: null, kind: 'screen' },
  'pos.sell': { moduleCode: 'pos', screenCode: 'pos-checkout', actionCode: null, kind: 'action' },
  'pos.void': { moduleCode: 'pos', screenCode: 'pos-returns', actionCode: null, kind: 'action' },
  'pos.session_manage': { moduleCode: 'pos', screenCode: 'pos-checkout', actionCode: null, kind: 'action' },
  'returns.view': { moduleCode: 'pos', screenCode: 'pos-returns', actionCode: null, kind: 'screen' },
  'returns.create': { moduleCode: 'pos', screenCode: 'pos-returns', actionCode: null, kind: 'action' },
  'returns.approve': { moduleCode: 'pos', screenCode: 'pos-returns', actionCode: null, kind: 'action' },
  'returns.receive': { moduleCode: 'pos', screenCode: 'pos-returns', actionCode: null, kind: 'action' },
  'returns.refund': { moduleCode: 'pos', screenCode: 'pos-returns', actionCode: null, kind: 'action' },
  'note.manage': { moduleCode: 'pos', screenCode: 'pos-returns', actionCode: null, kind: 'action' },
  'production.view': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'screen' },
  'production.manage_bom': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'production.create': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'production.release': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'production.consume': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'production.complete': { moduleCode: 'inventory', screenCode: null, actionCode: null, kind: 'action' },
  'crm.view': { moduleCode: 'crm', screenCode: 'crm-customers', actionCode: null, kind: 'screen' },
  'crm.profile_manage': { moduleCode: 'crm', screenCode: 'crm-customers', actionCode: null, kind: 'action' },
  'crm.timeline_view': { moduleCode: 'crm', screenCode: 'crm-customers', actionCode: null, kind: 'data' },
  'crm.timeline_note': { moduleCode: 'crm', screenCode: 'crm-customers', actionCode: null, kind: 'action' },
  'crm.loyalty_view': { moduleCode: 'crm', screenCode: 'crm-loyalty', actionCode: null, kind: 'screen' },
  'crm.loyalty_manage': { moduleCode: 'crm', screenCode: 'crm-loyalty', actionCode: null, kind: 'admin' },
  'crm.loyalty_redeem': { moduleCode: 'crm', screenCode: 'crm-loyalty', actionCode: null, kind: 'action' },
  'crm.loyalty_adjust': { moduleCode: 'crm', screenCode: 'crm-loyalty', actionCode: null, kind: 'action' },
  'crm.segment_view': { moduleCode: 'crm', screenCode: 'crm-segments', actionCode: null, kind: 'screen' },
  'crm.segment_manage': { moduleCode: 'crm', screenCode: 'crm-segments', actionCode: null, kind: 'action' },
  'crm.analytics_view': { moduleCode: 'crm', screenCode: 'crm-analytics', actionCode: null, kind: 'screen' },
  'crm.settings_manage': { moduleCode: 'crm', screenCode: null, actionCode: null, kind: 'admin' },
}
